      ...
      <div className="home__container">
        ...
        <div className="home__row">
          ...
          <Product
            ...
            rating={3}
            image={
              "https://m.media-amazon.com/images/I/61etD4-IrPL._AC_SX569_.jpg"
            }
          />
          {/* <Product /> */}
          {/* Product */}
        ...
        <div className="home__row">
          <Product
            id="90829332"
            title="Samasung LC49RG90SSuXEN 49' Curved LED Gaming Monitor - Super Ultra Wide Dual WQHD 5120 x 1440"
            price={239}
            rating={4}
            image={
